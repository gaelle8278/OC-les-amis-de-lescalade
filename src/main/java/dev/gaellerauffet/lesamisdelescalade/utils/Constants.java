package dev.gaellerauffet.lesamisdelescalade.utils;
...
public class Constants {
	...
	public final static String BOOKING_APP_PENDING_STATUS = "en attente";
	public final static String BOOKING_APP_CANCELLED_STATUS = "annulée";
